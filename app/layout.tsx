...
export const metadata: Metadata = {
  title: "OpenRouter AI Interface",
  description: "Web interface for OpenRouter AI API",
}
  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        {children}
        <Script id="openrouter-script" strategy="afterInteractive">
          {`
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function validateInputs() {
                    ...
                    if (splitMethodSelect.value === 'count') {
                        const splitLength = parseInt(splitLengthInput.value);
                ...
                function startProcessing() {
                    ...
                    const data = {
                        ...
                        splitLength: parseInt(splitLengthInput.value),
                ...
                function processChapters(data, chapters, index) {
                    ...
                    appendToElement(currentProgressDiv, \`Processing part \${index + 1}/\${chapters.length}\\nContent: \${chapter.substring(0, 100)}...\`);
                    ...
                    .then(result => {
                        ...
                        }, index < chapters.length - 1 ? 45000 : 0); // 45 second delay between requests
                    })
                    .catch(error => {
                        showError(error.message);
                        resetProcessingState();
